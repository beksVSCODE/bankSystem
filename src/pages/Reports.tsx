      ...
      <div className="flex-1 overflow-y-auto">
        {reportsMenuStructure.map(category => {
          ...
          return (
            ...
            >
              {Icon && <Icon className={`text-xl flex-shrink-0 ${isActive ? 'text-emerald-600' : 'text-gray-600'}`} />}
              <div className="flex-1 min-w-0">
                <div className={`font-semibold truncate ${isActive ? 'text-emerald-900' : 'text-gray-900'}`}>
                  {category.label}
                </div>
